...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="../view/assets/img/logo/logomoi.png" width="50px"
        alt="User Image">
      <div>
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item" href="index.php?act=listdm"><i
      ...
      <li><a class="app-menu__item" href="index.php?act=cmt"><i class="app-menu__icon bx bx-comment"></i><span class="app-menu__label">Quản lý bình luận</span></a>
      </li>

      <li><a class="app-menu__item" href="index.php?act=listtk"><i class='app-menu__icon bx bx-user-voice'></i><span
