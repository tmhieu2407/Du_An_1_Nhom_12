                ...
                <div class="tile-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control" type="number" name="soluong" value="<?= $soluong ?? '' ?>" min="0" step="any" required>
                        </div>

                        <div class="form-group col-md-3">
                            <label class="control-label">Giá</label>
                            <input class="form-control" type="number" name="gia" value="<?= $gia ?? '' ?>" min="0" step="any" required>
                        </div>
