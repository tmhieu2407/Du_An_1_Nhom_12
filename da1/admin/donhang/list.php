                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                    ...
                    <tbody>
                        ...
                        foreach ($list_dh as $dh) :
                            extract($dh);
                            $dhct = "index.php?act=ctdh&id_donhang=$id";
                            $thaydoi_ttdh = "index.php?act=suadh&id_donhang=$id";
                            $huy = "";
                        ?>
                            <tr>
                                <td><?= $id ?></td>
                                ...
                                <td>
                                    <a href="<?= $thaydoi_ttdh ?>">
                                        <button class="btn btn-primary btn-sm edit" type="button" title="Thay đổi trạng thái" id="show-emp" data-toggle="modal" data-target="#ModalUP"><i class="fas fa-edit"></i></button>
                                    </a>
                                    <a href="<?= $dhct ?>">
                                    ...
                                    <a href="index.php?act=xoadh&id_donhang=<?= $id ?>" onclick="return confirm('Bạn có chắc muốn xóa đơn hàng này?');">
