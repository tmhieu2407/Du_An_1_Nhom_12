                ...
                <div class="tile">
                    <div class="tile-body">
                        <div class="row element-button">
                            <div class="col-sm-2">
                            <a class="btn btn-add btn-sm" href="index.php?act=addtk" title="Thêm"><i class="fas fa-plus"></i>
                    ...
                    <div class="item-taikhoan">
                        <table>
                            ...
                            foreach ($listtaikhoan as $tk) {
                                ...
                                extract($tk);
                                $suataikhoan = "index.php?act=suatk&id=" . $id;
                                $xoataikhoan = "index.php?act=xoatk&id=" . $id;
                                if($capbac==1){
                                    $vaitro="Admin";
                                }else{
                                    $vaitro="Người dùng
